...
// forwards
static int ms_status(void *ctx, fh_message_t *msgin, fh_transport_t *transport);
static int ms_echo(void *ctx, fh_message_t *msgin, fh_transport_t *transport);
static int ms_close(void *ctx, fh_message_t *msgin, fh_transport_t *transport);
